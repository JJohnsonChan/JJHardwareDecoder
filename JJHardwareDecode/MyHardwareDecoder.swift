...
class MyHardwareDecoder {
    ...
    private func netPacket() -> Array<UInt8>? {
...
//        }
    ...
    private func receivedRawVideoFrame265(_ videoPacket: inout Array<UInt8>) {
...
//        print("Read Nalu size \(videoPacket.count)");
    ...
    private func receivedRawVideoFrame264(_ videoPacket: inout Array<UInt8>) {
...
//        print("Read Nalu size \(videoPacket.count)");
    ...
    private func decodeVideoPacket(_ videoPacket: Array<UInt8>) {
...
//            }
    ...
    private func createDecompSession265() -> Bool{
        formatDesc = nil
    ...
    private func createDecompSession264() -> Bool{
        formatDesc = nil
    ...
    fileprivate func displayDecodedFrame(_ imageBuffer: CVImageBuffer?) {
...
func decompressionSessionDecodeFrameCallback(_ decompressionOutputRefCon: UnsafeMutableRawPointer?, _ sourceFrameRefCon: UnsafeMutableRawPointer?, _ status: OSStatus, _ infoFlags: VTDecodeInfoFlags, _ imageBuffer: CVImageBuffer?, _ presentationTimeStamp: CMTime, _ presentationDuration: CMTime) -> Void {
    
    let streamManager: MyHardwareDecoder = unsafeBitCast(decompressionOutputRefCon, to: MyHardwareDecoder.self)
